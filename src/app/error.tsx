...
export default function GlobalError({
  ...
  return (
    <html lang="fr">
      <body className="min-h-screen bg-navy-50 flex items-center justify-center px-6 font-sans antialiased">
        <div className="text-center">
          ...
          <h1 className="text-xl font-semibold text-navy mb-2">Une erreur est survenue</h1>
