...
export default async function ConversationsPage() {
  ...
  if (!conversations || conversations.length === 0) {
    return (
      <div>
        <h1 className="text-2xl font-semibold text-navy mb-6">Conversations</h1>
        <div className="bg-white rounded-xl border border-zinc-200 flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm font-medium text-navy mb-1">Aucune conversation</p>
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-5">
        <h1 className="text-2xl font-semibold text-navy">Conversations</h1>
